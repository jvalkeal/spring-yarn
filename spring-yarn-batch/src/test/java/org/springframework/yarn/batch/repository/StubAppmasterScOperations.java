...
public class StubAppmasterScOperations implements AppmasterScOperations {
    ...
    private final static Log log = LogFactory.getLog(StubAppmasterScOperations.class);
    ...
    public RpcMessage<?> get(RpcMessage<?> message) {
        ...
        if (inHolder.getHeaders().get("type").equals("CreateJobInstanceReq")) {
            outHolder = handleCreateJobInstance(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("GetJobInstanceReq")) {
            outHolder = handleGetJobInstance(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("GetJobInstanceByIdReq")) {
            outHolder = handleGetJobInstanceById(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("GetJobNamesReq")) {
            outHolder = handleGetJobNames(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("GetJobInstancesReq")) {
            outHolder = handleGetJobInstances(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("SaveStepExecutionReq")) {
            outHolder = handleSaveStepExecution(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("AddStepExecutionsReq")) {
            outHolder = handleAddStepExecutions(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("UpdateStepExecutionReq")) {
            outHolder = handleUpdateStepExecution(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("GetStepExecutionReq")) {
            outHolder = handleGetStepExecution(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("SaveJobExecutionReq")) {
            outHolder = handleSaveJobExecution(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("SaveExecutionContextReq")) {
            outHolder = handleSaveExecutionContext(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("UpdateExecutionContextReq")) {
            outHolder = handleUpdateExecutionContext(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("FindJobExecutionsReq")) {
            outHolder = handleFindJobExecutions(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("FindRunningJobExecutionsReq")) {
            outHolder = handleFindRunningJobExecutions(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("GetJobExecutionReq")) {
            outHolder = handleGetJobExecution(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("GetLastJobExecutionReq")) {
            outHolder = handleGetLastJobExecution(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("UpdateJobExecutionReq")) {
            outHolder = handleUpdateJobExecution(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("SynchronizeStatusReq")) {
            outHolder = handleSynchronizeStatus(inHolder);
        } else if (inHolder.getHeaders().get("type").equals("GetExecutionContextReq")) {
